  ...
  <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
    <form method="POST">
      <div class="space-y-12">
        <div class=" pb-12">
          <h2 class="text-base font-semibold leading-7 text-gray-900">You can now create a note here :D</h2>
          <p class="mt-1 text-sm leading-6 text-gray-600">Say anything you want.</p>
